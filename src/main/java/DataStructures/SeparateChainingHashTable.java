    ...
    public class SeparateChainingHashTable<T>
    {
        ...
        {
            LinkedList whichList = theLists[ x.hashCode() % theLists.length ];
        ...
        {
           theLists[ x.hashCode() % theLists.length ].remove( x );
        }
        ...
        public T find( T x )
        {
            return (T)theLists[ x.hashCode() % theLists.length ].find( x ).retrieve( );
        }
