    ...
    public class BinomialQueue
    {
         ...
         */
        public void merge( BinomialQueue rhs ) throws IllegalStateException
        {
         ...
         */
        public void insert( Comparable x ) throws IllegalStateException
        {
        ...
        public static void main( String [ ] args )
        {
            ...
            catch( IllegalStateException e ) { System.out.println( "Unexpected overflow" ); } 
